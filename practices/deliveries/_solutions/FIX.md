...
Zero dependencies — `Intl.DateTimeFormat` with a `timeZone` is built in and DST-correct. After
this change: 15/15 unit tests stay green and `npm run grade` reports 7/7 worst-case.
