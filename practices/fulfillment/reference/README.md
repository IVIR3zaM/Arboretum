...
This directory is read-only external truth for the fulfillment domain: a sibling ERP
availability service's contract (`erp-availability-contract.md`), the available-to-promise (ATP)
